...
bool i2cdevReadByte(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint8_t* data) {
    return i2cdevRead(I2Cx, devAddress, memAddress, 1, data);
}

bool i2cdevReadBit(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint8_t bitNum, uint8_t* data) {
    uint8_t byte;
    bool status;
...
bool i2cdevReadBits(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint8_t bitStart, uint8_t length, uint8_t* data) {
    bool status;
    uint8_t byte;
...
bool i2cdevRead(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint16_t len, uint8_t* data) {
    bool status = TRUE;
...
bool i2cdevWriteByte(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint8_t data) {
...
bool i2cdevWriteBit(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint8_t bitNum, uint8_t data) {
    uint8_t byte;
...
bool i2cdevWriteBits(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint8_t bitStart, uint8_t length, uint8_t data) {
    bool status;
    uint8_t byte;
...
bool i2cdevWrite(I2C_Dev* I2Cx, uint8_t devAddress, uint8_t memAddress, uint16_t len, uint8_t* data) {
    bool status;
