...
static void mockEventPacketReceivedAnswerHandling(int dataLength, const packet_t* rxPacket, const dwTime_t* answerArrivalTagTime,
                                                  const packet_t* expectedTxPacket);
...
static lpsTwrAlgoOptions_t defaultOptions = {.tagAddress = 0xbccf000000000008,
                                             .anchorAddress = {0xbccf000000000001,
                                                               0xbccf000000000002,
                                                               0xbccf000000000003,
                                                               0xbccf000000000004,
                                                               0xbccf000000000005,
...
void testNormalMessageSequenceShouldGenerateDistance() {
    ...
    populatePacket(&expectedTxPacket1,
                   expectedSeqNr,
                   LPS_TWR_POLL,
                   defaultOptions.tagAddress,
    ...
    populatePacket(&expectedTxPacket2,
                   expectedSeqNr,
                   LPS_TWR_FINAL,
                   defaultOptions.tagAddress,
                   defaultOptions.anchorAddress[expectedAnchor]);
...
void testThatLppShortPacketIsSentWhenAvailable() {
    ...
    populateLppPacket(&expectedTxPacket,
                      lppShortPacketData,
                      lppShortPacketLength,
                      defaultOptions.tagAddress,
                      defaultOptions.anchorAddress[lppShortPacketDest]);
