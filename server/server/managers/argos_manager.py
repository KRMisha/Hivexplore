...
class ArgosManager(DroneManager):
    ...
    async def start(self):
        ...
        self._unix_socket_client.bind('Console', self._get_log_console_callback)
    ...
    def _get_log_console_callback(self, drone_id: str, data: str):
        for text in data.split("\n"):
            self._log_console_callback(drone_id, text)
