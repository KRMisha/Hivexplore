 ...
 *        Predict the measured sweep angle based on a position for a lighthouse rotor. The position is relative to the rotor reference
 * frame.
 * @param x meters
 * @param y meters
 * @param z meters
 ...
 *
 */
typedef float (*lighthouseCalibrationMeasurementModel_t)(const float x, const float y, const float z, const float t,
                                                         const lighthouseCalibrationSweep_t* calib);

/**
 * @brief Predict the measured sweep angle based on a position for a lighthouse 1 rotor. The position is relative to the rotor reference
 * frame.
 * @param x meters
 * @param y meters
 * @param z meters
 ...
 * @return float The predicted uncompensated sweep angle of the rotor
 */
float lighthouseCalibrationMeasurementModelLh1(const float x, const float y, const float z, const float t,
                                               const lighthouseCalibrationSweep_t* calib);

/**
 * @brief Predict the measured sweep angle based on a position for a lighthouse 2 rotor. The position is relative to the rotor reference
 * frame.
 * @param x meters
 * @param y meters
 * @param z meters
 ...
 * @return float The predicted uncompensated sweep angle of the rotor
 */
float lighthouseCalibrationMeasurementModelLh2(const float x, const float y, const float z, const float t,
                                               const lighthouseCalibrationSweep_t* calib);
