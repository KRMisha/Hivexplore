 ...
 */
const MotorPerifDef* motorMapDefaultBrushed[NBR_OF_MOTORS] = {&CONN_M1, &CONN_M2, &CONN_M3, &CONN_M4};
 ...
 * M4 -> RX2
 */
const MotorPerifDef* motorMapBigQuadDeck[NBR_OF_MOTORS] = {&DECK_TX2_TIM2, &DECK_IO3, &DECK_IO2, &DECK_RX2_TIM2};
 ...
 */
const MotorPerifDef* motorMapBoltBrushless[NBR_OF_MOTORS] = {&BOLT_M1_BL, &BOLT_M2_BL, &BOLT_M3_BL, &BOLT_M4_BL};
