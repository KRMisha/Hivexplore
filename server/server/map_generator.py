...
class MapGenerator:
    ...
    def set_position(self, drone_id: str, position: Point):
        ...
        self._web_socket_server.send_message(WebSocketEvent.DronePosition, {'droneId': drone_id, 'position': position})
    ...
    def add_range_reading(self, drone_id: str, range_reading: Range):
        ...
        self._web_socket_server.send_message(WebSocketEvent.MapPoints, points)

        lines = self._calculate_drone_sensor_lines(self._last_positions[drone_id], points)
        self._web_socket_server.send_message(WebSocketEvent.DroneSensorLines, {'droneId': drone_id, 'sensorLines': lines})
    ...
    def clear(self):
        self._points.clear()
        self._web_socket_server.send_message(WebSocketEvent.ClearMap, None)
    ...
    def _web_socket_connect_callback(self, client_id: str):
        self._web_socket_server.send_message_to_client(client_id, WebSocketEvent.MapPoints, self._points)
