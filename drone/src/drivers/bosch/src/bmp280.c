...
BMP280_RETURN_FUNCTION_TYPE bmp280_init(struct bmp280_t* bmp280) {
    ...
    /* read chip id */
    com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CHIP_ID_REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH); /* read Chip Id */
...
BMP280_RETURN_FUNCTION_TYPE bmp280_read_uncomp_temperature(int32_t* v_uncomp_temperature_s32) {
     ...
     */
    uint8_t a_data_u8r[BMP280_TEMPERATURE_DATA_SIZE] = {BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE};
    /* check the p_bmp280 structure pointer as NULL*/
    if (p_bmp280 == BMP280_NULL) {
        return E_BMP280_NULL_PTR;
    } else {
        /* read temperature data */
        com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_TEMPERATURE_MSB_REG, a_data_u8r, BMP280_TEMPERATURE_DATA_LENGTH);
        *v_uncomp_temperature_s32 =
            (int32_t)((((uint32_t)(a_data_u8r[BMP280_TEMPERATURE_MSB_DATA])) << BMP280_SHIFT_BIT_POSITION_BY_12_BITS) |
                      (((uint32_t)(a_data_u8r[BMP280_TEMPERATURE_LSB_DATA])) << BMP280_SHIFT_BIT_POSITION_BY_04_BITS) |
                      ((uint32_t)a_data_u8r[BMP280_TEMPERATURE_XLSB_DATA] >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS));
    }
    return com_rslt;
}
/*!
...
int32_t bmp280_compensate_temperature_s32(int32_t v_uncomp_temperature_s32) {
    ...
    /*calculate x1*/
    v_x1_u32r = ((((v_uncomp_temperature_s32 >> BMP280_SHIFT_BIT_POSITION_BY_03_BITS) -
                   ((int32_t)p_bmp280->calib_param.dig_T1 << BMP280_SHIFT_BIT_POSITION_BY_01_BIT))) *
                 ((int32_t)p_bmp280->calib_param.dig_T2)) >>
                BMP280_SHIFT_BIT_POSITION_BY_11_BITS;
    /*calculate x2*/
    v_x2_u32r = (((((v_uncomp_temperature_s32 >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS) - ((int32_t)p_bmp280->calib_param.dig_T1)) *
                   ((v_uncomp_temperature_s32 >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS) - ((int32_t)p_bmp280->calib_param.dig_T1))) >>
    ...
    temperature = (p_bmp280->calib_param.t_fine * 5 + 128) >> BMP280_SHIFT_BIT_POSITION_BY_08_BITS;
...
BMP280_RETURN_FUNCTION_TYPE bmp280_read_uncomp_pressure(int32_t* v_uncomp_pressure_s32) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_PRESSURE_MSB_REG, a_data_u8, BMP280_PRESSURE_DATA_LENGTH);
        *v_uncomp_pressure_s32 = (int32_t)((((uint32_t)(a_data_u8[BMP280_PRESSURE_MSB_DATA])) << BMP280_SHIFT_BIT_POSITION_BY_12_BITS) |
...
uint32_t bmp280_compensate_pressure_s32(int32_t v_uncomp_pressure_s32) {
    ...
    /* calculate x1*/
    v_x1_u32r = (((int32_t)p_bmp280->calib_param.t_fine) >> BMP280_SHIFT_BIT_POSITION_BY_01_BIT) - (int32_t)64000;
    /* calculate x2*/
    v_x2_u32r = (((v_x1_u32r >> BMP280_SHIFT_BIT_POSITION_BY_02_BITS) * (v_x1_u32r >> BMP280_SHIFT_BIT_POSITION_BY_02_BITS)) >>
                 BMP280_SHIFT_BIT_POSITION_BY_11_BITS) *
                ((int32_t)p_bmp280->calib_param.dig_P6);
    v_x2_u32r = v_x2_u32r + ((v_x1_u32r * ((int32_t)p_bmp280->calib_param.dig_P5)) << BMP280_SHIFT_BIT_POSITION_BY_01_BIT);
    v_x2_u32r = (v_x2_u32r >> BMP280_SHIFT_BIT_POSITION_BY_02_BITS) +
                (((int32_t)p_bmp280->calib_param.dig_P4) << BMP280_SHIFT_BIT_POSITION_BY_16_BITS);
    /* calculate x1*/
    v_x1_u32r = (((p_bmp280->calib_param.dig_P3 *
                   (((v_x1_u32r >> BMP280_SHIFT_BIT_POSITION_BY_02_BITS) * (v_x1_u32r >> BMP280_SHIFT_BIT_POSITION_BY_02_BITS)) >>
                    BMP280_SHIFT_BIT_POSITION_BY_13_BITS)) >>
                  BMP280_SHIFT_BIT_POSITION_BY_03_BITS) +
                 ((((int32_t)p_bmp280->calib_param.dig_P2) * v_x1_u32r) >> BMP280_SHIFT_BIT_POSITION_BY_01_BIT)) >>
                BMP280_SHIFT_BIT_POSITION_BY_18_BITS;
    v_x1_u32r = ((((32768 + v_x1_u32r)) * ((int32_t)p_bmp280->calib_param.dig_P1)) >> BMP280_SHIFT_BIT_POSITION_BY_15_BITS);
    /* calculate pressure*/
    v_pressure_u32 =
        (((uint32_t)(((int32_t)1048576) - v_uncomp_pressure_s32) - (v_x2_u32r >> BMP280_SHIFT_BIT_POSITION_BY_12_BITS))) * 3125;
    /* check overflow*/
    if (v_pressure_u32 < 0x80000000)
        /* Avoid exception caused by division by zero */
        if (v_x1_u32r != BMP280_INIT_VALUE)
            v_pressure_u32 = (v_pressure_u32 << BMP280_SHIFT_BIT_POSITION_BY_01_BIT) / ((uint32_t)v_x1_u32r);
        else
    ...
    /* calculate x1*/
    v_x1_u32r =
        (((int32_t)p_bmp280->calib_param.dig_P9) *
         ((int32_t)(((v_pressure_u32 >> BMP280_SHIFT_BIT_POSITION_BY_03_BITS) * (v_pressure_u32 >> BMP280_SHIFT_BIT_POSITION_BY_03_BITS)) >>
                    BMP280_SHIFT_BIT_POSITION_BY_13_BITS))) >>
        BMP280_SHIFT_BIT_POSITION_BY_12_BITS;
    /* calculate x2*/
    v_x2_u32r = (((int32_t)(v_pressure_u32 >> BMP280_SHIFT_BIT_POSITION_BY_02_BITS)) * ((int32_t)p_bmp280->calib_param.dig_P8)) >>
                BMP280_SHIFT_BIT_POSITION_BY_13_BITS;
    /* calculate x3*/
    v_x3_u32r = (int32_t)(
        ((int32_t)(((v_pressure_u32 >> BMP280_SHIFT_BIT_POSITION_BY_03_BITS) * (v_pressure_u32 >> BMP280_SHIFT_BIT_POSITION_BY_03_BITS)) >>
                   BMP280_SHIFT_BIT_POSITION_BY_08_BITS) *
         ((int32_t)((((int32_t)p_bmp280->calib_param.dig_P10) * (int32_t)v_pressure_u32) >> BMP280_SHIFT_BIT_POSITION_BY_14_BITS))) >>
        BMP280_SHIFT_BIT_POSITION_BY_13_BITS);
    /* calculate true pressure*/
    v_pressure_u32 = (uint32_t)((int32_t)v_pressure_u32 + ((v_x1_u32r + v_x2_u32r + v_x3_u32r + p_bmp280->calib_param.dig_P7) >>
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_read_uncomp_pressure_temperature(int32_t* v_uncomp_pressure_s32, int32_t* v_uncomp_temperature_s32) {
    /* variable used to return communication result*/
    BMP280_RETURN_FUNCTION_TYPE com_rslt = ERROR;
     ...
     */
    uint8_t a_data_u8[BMP280_ALL_DATA_FRAME_LENGTH] =
        {BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE};
    /* check the p_bmp280 structure pointer as NULL*/
    if (p_bmp280 == BMP280_NULL) {
        return E_BMP280_NULL_PTR;
    } else {
        com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_PRESSURE_MSB_REG, a_data_u8, BMP280_DATA_FRAME_SIZE);
        /*Pressure*/
        *v_uncomp_pressure_s32 =
            (int32_t)((((uint32_t)(a_data_u8[BMP280_DATA_FRAME_PRESSURE_MSB_BYTE])) << BMP280_SHIFT_BIT_POSITION_BY_12_BITS) |
                      (((uint32_t)(a_data_u8[BMP280_DATA_FRAME_PRESSURE_LSB_BYTE])) << BMP280_SHIFT_BIT_POSITION_BY_04_BITS) |
                      ((uint32_t)a_data_u8[BMP280_DATA_FRAME_PRESSURE_XLSB_BYTE] >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS));

        /* Temperature */
        *v_uncomp_temperature_s32 =
            (int32_t)((((uint32_t)(a_data_u8[BMP280_DATA_FRAME_TEMPERATURE_MSB_BYTE])) << BMP280_SHIFT_BIT_POSITION_BY_12_BITS) |
                      (((uint32_t)(a_data_u8[BMP280_DATA_FRAME_TEMPERATURE_LSB_BYTE])) << BMP280_SHIFT_BIT_POSITION_BY_04_BITS) |
                      ((uint32_t)a_data_u8[BMP280_DATA_FRAME_TEMPERATURE_XLSB_BYTE] >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS));
    }
    return com_rslt;
}
/*!
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_read_pressure_temperature(uint32_t* v_pressure_u32, int32_t* v_temperature_s32) {
    /* variable used to return communication result*/
    BMP280_RETURN_FUNCTION_TYPE com_rslt = ERROR;
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        *v_temperature_s32 = bmp280_compensate_temperature_s32(v_uncomp_temperature_s32);
        *v_pressure_u32 = bmp280_compensate_pressure_s32(v_uncomp_pressure_s32);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_calib_param(void) {
    /* variable used to return communication result*/
    BMP280_RETURN_FUNCTION_TYPE com_rslt = ERROR;
    uint8_t a_data_u8[BMP280_CALIB_DATA_SIZE] = {BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE,
                                                 BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE,
                                                 BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE,
                                                 BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE,
                                                 BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE,
                                                 BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE, BMP280_INIT_VALUE,
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        p_bmp280->calib_param.dig_T1 =
            (uint16_t)((((uint16_t)((uint8_t)a_data_u8[BMP280_TEMPERATURE_CALIB_DIG_T1_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                       a_data_u8[BMP280_TEMPERATURE_CALIB_DIG_T1_LSB]);
        p_bmp280->calib_param.dig_T2 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_TEMPERATURE_CALIB_DIG_T2_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_TEMPERATURE_CALIB_DIG_T2_LSB]);
        p_bmp280->calib_param.dig_T3 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_TEMPERATURE_CALIB_DIG_T3_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_TEMPERATURE_CALIB_DIG_T3_LSB]);
        p_bmp280->calib_param.dig_P1 =
            (uint16_t)((((uint16_t)((uint8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P1_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                       a_data_u8[BMP280_PRESSURE_CALIB_DIG_P1_LSB]);
        p_bmp280->calib_param.dig_P2 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P2_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P2_LSB]);
        p_bmp280->calib_param.dig_P3 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P3_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P3_LSB]);
        p_bmp280->calib_param.dig_P4 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P4_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P4_LSB]);
        p_bmp280->calib_param.dig_P5 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P5_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P5_LSB]);
        p_bmp280->calib_param.dig_P6 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P6_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P6_LSB]);
        p_bmp280->calib_param.dig_P7 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P7_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P7_LSB]);
        p_bmp280->calib_param.dig_P8 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P8_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P8_LSB]);
        p_bmp280->calib_param.dig_P9 =
            (int16_t)((((int16_t)((int8_t)a_data_u8[BMP280_PRESSURE_CALIB_DIG_P9_MSB])) << BMP280_SHIFT_BIT_POSITION_BY_08_BITS) |
                      a_data_u8[BMP280_PRESSURE_CALIB_DIG_P9_LSB]);
        p_bmp280->calib_param.dig_P10 = (int8_t)(a_data_u8[BMP280_PRESSURE_CALIB_DIG_P10]);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_oversamp_temperature(uint8_t* v_value_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        *v_value_u8 = BMP280_GET_BITSLICE(v_data_u8, BMP280_CTRL_MEAS_REG_OVERSAMP_TEMPERATURE);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_oversamp_pressure(uint8_t v_value_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        if (com_rslt == SUCCESS) {
            ...
            v_data_u8 = BMP280_SET_BITSLICE(v_data_u8, BMP280_CTRL_MEAS_REG_OVERSAMP_PRESSURE, v_value_u8);
            com_rslt += p_bmp280->bus_write(p_bmp280->dev_addr,
                                            BMP280_CTRL_MEAS_REG_OVERSAMP_PRESSURE__REG,
                                            &v_data_u8,
                                            BMP280_GEN_READ_WRITE_DATA_LENGTH);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_power_mode(uint8_t* v_power_mode_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        /* read the power mode*/
        com_rslt =
            p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CTRL_MEAS_REG_POWER_MODE__REG, &v_mode_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        *v_power_mode_u8 = BMP280_GET_BITSLICE(v_mode_u8, BMP280_CTRL_MEAS_REG_POWER_MODE);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_power_mode(uint8_t v_power_mode_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        if (v_power_mode_u8 <= BMP280_NORMAL_MODE) {
            ...
            v_mode_u8 = (p_bmp280->oversamp_temperature << BMP280_SHIFT_BIT_POSITION_BY_05_BITS) +
                        (p_bmp280->oversamp_pressure << BMP280_SHIFT_BIT_POSITION_BY_02_BITS) + v_power_mode_u8;
            com_rslt = p_bmp280->bus_write(p_bmp280->dev_addr,
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_soft_rst(void) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        /* write soft reset */
        com_rslt = p_bmp280->bus_write(p_bmp280->dev_addr, BMP280_RST_REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_spi3(uint8_t* v_enable_disable_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        com_rslt =
            p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CONFIG_REG_SPI3_ENABLE__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        *v_enable_disable_u8 = BMP280_GET_BITSLICE(v_data_u8, BMP280_CONFIG_REG_SPI3_ENABLE);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_spi3(uint8_t v_enable_disable_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        com_rslt =
            p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CONFIG_REG_SPI3_ENABLE__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        if (com_rslt == SUCCESS) {
            v_data_u8 = BMP280_SET_BITSLICE(v_data_u8, BMP280_CONFIG_REG_SPI3_ENABLE, v_enable_disable_u8);
            com_rslt +=
                p_bmp280->bus_write(p_bmp280->dev_addr, BMP280_CONFIG_REG_SPI3_ENABLE__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        }
    }
    return com_rslt;
}
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_filter(uint8_t* v_value_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        /* read filter*/
        com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CONFIG_REG_FILTER__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        *v_value_u8 = BMP280_GET_BITSLICE(v_data_u8, BMP280_CONFIG_REG_FILTER);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_filter(uint8_t v_value_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        if (com_rslt == SUCCESS) {
            ...
            com_rslt +=
                p_bmp280->bus_write(p_bmp280->dev_addr, BMP280_CONFIG_REG_FILTER__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        }
    }
    return com_rslt;
}
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_standby_durn(uint8_t* v_standby_durn_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        com_rslt =
            p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CONFIG_REG_STANDBY_DURN__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        *v_standby_durn_u8 = BMP280_GET_BITSLICE(v_data_u8, BMP280_CONFIG_REG_STANDBY_DURN);
    }
    return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_standby_durn(uint8_t v_standby_durn_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        if (com_rslt == SUCCESS) {
            ...
            com_rslt +=
                p_bmp280->bus_write(p_bmp280->dev_addr, BMP280_CONFIG_REG_STANDBY_DURN__REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
        }
    }
    return com_rslt;
}
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_work_mode(uint8_t v_work_mode_u8) {
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        if (v_work_mode_u8 <= BMP280_ULTRA_HIGH_RESOLUTION_MODE) {
            com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, BMP280_CTRL_MEAS_REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
            if (com_rslt == SUCCESS) {
                ...
                v_data_u8 = BMP280_SET_BITSLICE(v_data_u8, BMP280_CTRL_MEAS_REG_OVERSAMP_TEMPERATURE, p_bmp280->oversamp_temperature);
                v_data_u8 = BMP280_SET_BITSLICE(v_data_u8, BMP280_CTRL_MEAS_REG_OVERSAMP_PRESSURE, p_bmp280->oversamp_pressure);
                com_rslt += p_bmp280->bus_write(p_bmp280->dev_addr, BMP280_CTRL_MEAS_REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
            }
        } else {
            com_rslt = E_BMP280_OUT_OF_RANGE;
        }
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_get_forced_uncomp_pressure_temperature(int32_t* v_uncomp_pressure_s32,
    ...
    if (p_bmp280 == BMP280_NULL) {
        ...
        v_data_u8 = (p_bmp280->oversamp_temperature << BMP280_SHIFT_BIT_POSITION_BY_05_BITS) +
                    (p_bmp280->oversamp_pressure << BMP280_SHIFT_BIT_POSITION_BY_02_BITS) + BMP280_FORCED_MODE;
        com_rslt = p_bmp280->bus_write(p_bmp280->dev_addr, BMP280_CTRL_MEAS_REG, &v_data_u8, BMP280_GEN_READ_WRITE_DATA_LENGTH);
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_write_register(uint8_t v_addr_u8, uint8_t* v_data_u8, uint8_t v_len_u8) {
    /* variable used to return communication result*/
    BMP280_RETURN_FUNCTION_TYPE com_rslt = ERROR;
    /* check the p_bmp280 structure pointer as NULL*/
    if (p_bmp280 == BMP280_NULL) {
        ...
        com_rslt = p_bmp280->bus_write(p_bmp280->dev_addr, v_addr_u8, v_data_u8, v_len_u8);
    }
    return com_rslt;
}
/*!
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_read_register(uint8_t v_addr_u8, uint8_t* v_data_u8, uint8_t v_len_u8) {
    /* variable used to return communication result*/
    BMP280_RETURN_FUNCTION_TYPE com_rslt = ERROR;
    /* check the p_bmp280 structure pointer as NULL*/
    if (p_bmp280 == BMP280_NULL) {
        ...
        com_rslt = p_bmp280->bus_read(p_bmp280->dev_addr, v_addr_u8, v_data_u8, v_len_u8);
    }
    return com_rslt;
}
...
float bmp280_compensate_temperature_float(int32_t v_uncomp_temperature_s32) {
    ...
    /* calculate x1*/
    v_x1_u32r = (((float)v_uncomp_temperature_s32) / 16384.0f - ((float)p_bmp280->calib_param.dig_T1) / 1024.0f) *
    ...
    v_x2_u32r = ((((float)v_uncomp_temperature_s32) / 131072.0f - ((float)p_bmp280->calib_param.dig_T1) / 8192.0f) *
                 (((float)v_uncomp_temperature_s32) / 131072.0f - ((float)p_bmp280->calib_param.dig_T1) / 8192.0f)) *
...
float bmp280_compensate_pressure_float(int32_t v_uncomp_pressure_s32) {
    ...
    v_x1_u32r =
        (((float)p_bmp280->calib_param.dig_P3) * v_x1_u32r * v_x1_u32r / 524288.0f + ((float)p_bmp280->calib_param.dig_P2) * v_x1_u32r) /
        524288.0f;
    ...
    /* calculate x3*/
    v_x3_u32r = ((v_pressure_diff_dbl * v_pressure_diff_dbl * v_pressure_diff_dbl * (float)p_bmp280->calib_param.dig_P10) / 131072.0f);
    /* calculate true pressure*/
    pressure = pressure + (v_x1_u32r + v_x2_u32r + v_x3_u32r + ((float)p_bmp280->calib_param.dig_P7)) / 16.0f;
...
uint32_t bmp280_compensate_pressure_int64(int32_t v_uncomp_pressure_s32) {
    ...
    v_x2_s64r = v_x1_s64r * v_x1_s64r * (int64_t)p_bmp280->calib_param.dig_P6;
    /* calculate x2*/
    v_x2_s64r = v_x2_s64r + ((v_x1_s64r * (int64_t)p_bmp280->calib_param.dig_P5) << BMP280_SHIFT_BIT_POSITION_BY_17_BITS);
    v_x2_s64r = v_x2_s64r + (((int64_t)p_bmp280->calib_param.dig_P4) << BMP280_SHIFT_BIT_POSITION_BY_35_BITS);
    v_x1_s64r = ((v_x1_s64r * v_x1_s64r * (int64_t)p_bmp280->calib_param.dig_P3) >> BMP280_SHIFT_BIT_POSITION_BY_08_BITS) +
                ((v_x1_s64r * (int64_t)p_bmp280->calib_param.dig_P2) << BMP280_SHIFT_BIT_POSITION_BY_12_BITS);
    v_x1_s64r = (((((int64_t)1) << BMP280_SHIFT_BIT_POSITION_BY_47_BITS) + v_x1_s64r)) * ((int64_t)p_bmp280->calib_param.dig_P1) >>
                BMP280_SHIFT_BIT_POSITION_BY_33_BITS;
    pressure = 1048576 - v_uncomp_pressure_s32;
    if (v_x1_s64r != BMP280_INIT_VALUE)
#if defined __KERNEL__
        pressure = div64_s64((((pressure << BMP280_SHIFT_BIT_POSITION_BY_31_BITS) - v_x2_s64r) * 3125), v_x1_s64r);
#else
        pressure = (((pressure << BMP280_SHIFT_BIT_POSITION_BY_31_BITS) - v_x2_s64r) * 3125) / v_x1_s64r;
#endif
    else
        return BMP280_INVALID_DATA;
    v_x1_s64r = (((int64_t)p_bmp280->calib_param.dig_P9) * (pressure >> BMP280_SHIFT_BIT_POSITION_BY_13_BITS) *
                 (pressure >> BMP280_SHIFT_BIT_POSITION_BY_13_BITS)) >>
                BMP280_SHIFT_BIT_POSITION_BY_25_BITS;
    v_x2_s64r = (((int64_t)p_bmp280->calib_param.dig_P8) * pressure) >> BMP280_SHIFT_BIT_POSITION_BY_19_BITS;
    /* calculate x3*/
    v_x3_s64r =
        (int64_t)(((int64_t)(((pressure >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS) * (pressure >> BMP280_SHIFT_BIT_POSITION_BY_04_BITS)) >>
                             BMP280_SHIFT_BIT_POSITION_BY_30_BITS) *
                   (int64_t)((pressure * (int64_t)p_bmp280->calib_param.dig_P10) >> BMP280_SHIFT_BIT_POSITION_BY_10_BITS)) >>
                  BMP280_SHIFT_BIT_POSITION_BY_29_BITS);
    /* calculate true pressure*/
    pressure = ((pressure + v_x1_s64r + v_x2_s64r + v_x3_s64r) >> BMP280_SHIFT_BIT_POSITION_BY_08_BITS) +
               (((int64_t)p_bmp280->calib_param.dig_P7) << BMP280_SHIFT_BIT_POSITION_BY_04_BITS);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_compute_wait_time(uint8_t* v_delaytime_u8r) {
    ...
    *v_delaytime_u8r = (T_INIT_MAX +
                        T_MEASURE_PER_OSRS_MAX * (((1 << p_bmp280->oversamp_temperature) >> BMP280_SHIFT_BIT_POSITION_BY_01_BIT) +
                                                  ((1 << p_bmp280->oversamp_pressure) >> BMP280_SHIFT_BIT_POSITION_BY_01_BIT)) +
                        ((p_bmp280->oversamp_pressure > 0) ? T_SETUP_PRESSURE_MAX : 0) + 15) /
                       16;
    return com_rslt;
}
