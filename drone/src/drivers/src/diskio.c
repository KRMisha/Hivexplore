...
DRESULT disk_read(BYTE pdrv, /* Physical drive nmuber (0..) */
    ...
    if (FATFS_LowLevelDrivers[pdrv].disk_read) {
        return FATFS_LowLevelDrivers[pdrv].disk_read(buff, sector, count, FATFS_LowLevelDrivers[pdrv].usrOps);
    }
...
DRESULT disk_write(BYTE pdrv, /* Physical drive nmuber (0..) */
    ...
    if (FATFS_LowLevelDrivers[pdrv].disk_write) {
        return FATFS_LowLevelDrivers[pdrv].disk_write(buff, sector, count, FATFS_LowLevelDrivers[pdrv].usrOps);
    }
...
DRESULT disk_ioctl(BYTE pdrv, /* Physical drive nmuber (0..) */
    ...
    if (FATFS_LowLevelDrivers[pdrv].disk_ioctl) {
        return FATFS_LowLevelDrivers[pdrv].disk_ioctl(cmd, buff, FATFS_LowLevelDrivers[pdrv].usrOps);
    }
