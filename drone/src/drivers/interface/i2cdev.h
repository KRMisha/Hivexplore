 ...
 * @return TRUE if write was successful, otherwise FALSE.
 */
bool i2cdevWriteReg8(I2C_Dev* dev, uint8_t devAddress, uint8_t memAddress, uint16_t len, const uint8_t* data);
 ...
 * @return TRUE if write was successful, otherwise FALSE.
 */
bool i2cdevWriteReg16(I2C_Dev* dev, uint8_t devAddress, uint16_t memAddress, uint16_t len, const uint8_t* data);
