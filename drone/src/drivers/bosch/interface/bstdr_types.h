 ...
 *
 */
typedef enum { BSTDR_NO_INTERFACE = 0, BSTDR_I2C_INTERFACE = 1, BSTDR_SPI3_INTERFACE = 3, BSTDR_SPI4_INTERFACE = 4 } bstdr_interface_t;

#define BSTDR_BITS_MSK(bitspos, bitslen) (((0xff >> (8 - bitslen)) << bitspos))
#define BSTDR_GET_BITSLICE(regvar, bitspos, bitslen) ((regvar & BSTDR_BITS_MSK(bitspos, bitslen)) >> bitspos)
